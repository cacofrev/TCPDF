...
$pdf->SetHeaderData('', '2', 'ASISTENCIA IRCS', '');
...
<tr>
    <th colspan="4">FECHA <strong>(DATE)</strong></th><th colspan="12" ></th>
</tr>

<tr>
    <th colspan="4" style="border-right:1px solid transparent">LUGAR (TERMINAL) <strong>(PLACE)</strong></th><th colspan="12" ></th>
</tr>

<tr>
    <th colspan="5" style="text-align:left;">SERVICIO SOLICITADO POR <strong>(REQUESTED BY)</strong></th> <th colspan="3" style="text-align:left;"></th>
    <th colspan="3" style="text-align:left;">TECNICO <strong>(TECHNICIAN)</strong></th> <th colspan="5" style="text-align:left;"></th>
</tr>

<tr>
    <th colspan="5" style="text-align:left;">NAVIERA <strong>(SHIPPER OWNER)</strong></th> <th colspan="3" style="text-align:left;"></th>
    <th colspan="4" style="text-align:left;">N° UNIDAD <strong>(CONTAINER UNIT)</strong></th> <th colspan="4" style="text-align:left;"></th>
</tr>

<tr>
    <th colspan="5" style="text-align:left;">NAVE <strong>(VESSEL)</strong></th> <th colspan="3" style="text-align:left;"></th>
    <th colspan="3" style="text-align:left;">MAQUINARIA <strong>(MACHINERY)</strong></th> <th colspan="5" style="text-align:left;"></th>
</tr>
...
<tr>
    ...
    <th rowspan="12" colspan="4" style="text-align:left;"><label><img src="images/dyc.jpg"></label></th>
...
<tr>
    <th colspan="5" style="text-align:center;"><strong>PART NUMBER</strong></th>
    <th colspan="5" style="text-align:center;"><strong>DESCRIPTION</strong></th>
    <th colspan="3" style="text-align:center;"><strong>QUANTITY</strong></th>
    <th colspan="3" style="text-align:center;"><strong>WARRANTY</strong></th>
</tr>
<tr>
...
<tr>
    <th colspan="1" style="text-align:left; border: 0px solid transparent"></th>
    <th colspan="3" style="text-align:center;"><strong>Nombre / Firma<br>Representante Cliente</strong></th>
    <th colspan="2" style="text-align:left;"></th>

    <th colspan="4" style="text-align:center;"><strong>José Patricio Latorre<br>Depósito y Contenedores S.A.<br>Encargado 24/7</strong></th>

    <th colspan="2" style="text-align:left;"></th>
    <th colspan="3" style="text-align:center;"><strong>Nombre / Firma<br>Técnico Reefer</strong></th>
</tr>
